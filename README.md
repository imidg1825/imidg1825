...
<p align="center">
  🤖 <b>Мой AI-наставник для обучения Python/QA:</b>
  <a href="#ai-mentor">перейти к описанию ↓</a>
</p>
---
...
Я создал собственного AI-наставника для обучения Python и QA Automation: помогает разбирать код и ошибки, объясняет инструменты простым языком и тренирует на реальных QA-задачах.

👉 **Открыть AI-наставника:** [Python QA Mentor PRO](https://chatgpt.com/g/g-69312d733318819181e22b0fffe5c7fe-python-qa-mentor-pro)
---
