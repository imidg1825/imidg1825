...
---
### 🧪 Тестирование  
- 📌 **Функциональные тест-кейсы** — в финальной работе (YoNote)  
- 📌 **Нефункциональные тест-кейсы** — в финальной работе (YoNote)  
- 📌 **Тест-план и тестовая документация** — в финальной работе (YoNote)

### 🐞 Баг-репорты  
- 📌 **Коллекция багов (Ёжка)** — входит в финальную работу (YoNote)
