...
## 📦 Мои учебные проекты (Git + Python)

```text
  ____        _   _             _             
 |  _ \ _   _| |_| |_ ___ _ __ | | ___   __ _ 
 | |_) | | | | __| __/ _ \ '_ \| |/ _ \ / _` |
 |  __/| |_| | |_| ||  __/ | | | | (_) | (_| |
 |_|    \__,_|\__|\__\___|_| |_|_|\___/ \__, |
                                        |___/ 
| Репозиторий                                                                   | Описание                                     | Технологии       |
| ----------------------------------------------------------------------------- | -------------------------------------------- | ---------------- |
| [**git-training-ivan**](https://github.com/imidg1825/git-training-ivan)       | Практика работы с Git, ветками и конфликтами | Git, GitHub      |
| [**python_training_2025**](https://github.com/imidg1825/python_training_2025) | Python и автоматизация тестирования          | Python, Selenium |
